...
const CardContainer = styled(motion.div)(({ theme, hovered }) => ({
  ...
  position: 'absolute',
  border: hovered ? `4px solid ${theme.palette.info.main}` : 'none',
  overflow: 'hidden',
...
const CardStack = () => {
  ...
  const svgUrl = [
    '/src/assets/ieproj.svg',
    '/src/assets/competition.svg',
        ...
        {[0, 1, 2].map((cardId, index) => (
          <CardContainer
            ...
            style={{
              ...
              left: `${index === 1 ? index * 100 : 0}px`, // 控制遮挡关系
            }}
                ...
                <Stack direction='row' spacing={2}>
                  <>
                    <Typography variant='h6'>
                      {popularProj[index]?.name.substring(0, 5)}
                    </Typography>
