    ...
    return (
        <Box
            ...
            <Breadcrumbs separator={<NavigateNextIcon/>}>
                ...
                <Link underline="hover" key="2" color="inherit" sx={{cursor: 'pointer'}} onClick={() => {
            ...
            <TabPanel value={value} index={0}>
                <Stack direction="column" width="100%" height="100%" spacing={3} sx={{mt: 5}}>
                    ...
                    <Typography variant="body1">项目所需总人数：{Project.required}</Typography>
                    <Typography variant="body1">专业限制：{Project.major}</Typography>
                    <Typography variant="body1">简介：{Project.brief}</Typography>
                    <Typography variant="body1">指导老师：{Project.instructor}</Typography>
                    <Typography variant="body1">项目负责人：{Project.leader}</Typography>
                    <Typography variant="body2" color="textSecondary">详细描述：{Project.detail}</Typography>
                </Stack>
            </TabPanel>
            <TabPanel value={value} index={1}>
                <Stack sx={{mt: 5}} height="50vh" spacing={3}>
                    <TextField label="申请信息"
                               multiline
                               rows={6}
                               fullWidth/>
                    <Button
                    ...
                    >
                        <SnackbarContent
                            sx={{
                                ...
                                alignItems: 'center',
                                backgroundColor: applied ? theme.palette.error.light : theme.palette.success.light,
                                color: 'white'
                            }}
